...
Route::group(['middleware' => ['admin', 'locale']], function(){
    ...
    Route::post('ajax/location/changeStatus', [AjaxDashboardController::class, 'changeStatus'])->name('ajax.location.changeStatus');
    Route::post('ajax/location/changeStatusAll', [AjaxDashboardController::class, 'changeStatusAll'])->name('ajax.location.changeStatusAll');

});

Route::get('admin', [AuthController::class, 'index'])
->name('auth.admin')->middleware(middleware:'login');
